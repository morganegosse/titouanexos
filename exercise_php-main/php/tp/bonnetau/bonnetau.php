...
<body>
    ...
    <main class="text-center">
        ...
        <?php
            if (isset($_POST['g1']) && $ball === 1) {
                echo "<h3>Bravo elle était bien sous le gobelet 1</h3>";
            }elseif(isset($_POST['g1']) && $ball != 1) {
                echo "<h3>Vous avez perdu</h3>";
            }

            if (isset($_POST['g2']) && $ball === 2) {
                echo "<h3>Bravo elle était bien sous le gobelet 2</h3>";
            }elseif(isset($_POST['g2']) && $ball != 2) {
                echo "<h3>Vous avez perdu</h3>";
            }

            if (isset($_POST['g3']) && $ball === 3) {
                echo "<h3>Bravo elle était bien sous le gobelet 3</h3>";
            }elseif(isset($_POST['g3']) && $ball != 3) {
                echo "<h3>Vous avez perdu</h3>";
            }
        ?>
    </main>
